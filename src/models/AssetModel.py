...
class AssetModel(BaseDataModel):
    ...
    # def __init__(self):
    #     super().__init__(DataBaseEnum.COLLECTION_ASSET_NAME, Asset)
    ...
    async def create_instance(cls, db_client):
        instance = cls(db_client=db_client)  # matches __init__
        await instance.create_indexes(Asset.get_indexes())
        return instance
